                ...
                <div class="post-container">
                  ...
                  <h2 class="page-heading">Search : <?php echo $search_tram; ?></h2>
                    ...
                    if(mysqli_num_rows($result1)){
                        ...
                        if($page > 1){
                            echo "<li><a href='author.php?search=".$search_tram."&page=".($page - 1)."'>PREV</a></li>";
                        }
                        for ($i=1; $i <=$total_page ; $i++) { 
                            ...
                            echo "<li class='".$active."'><a href='author.php?search=".$search_tram."&page=".$i."'>".$i."</a></li>";
                        }
                        if($page < $total_page){
                            echo "<li><a href='author.php?search=".$search_tram."&page=".($page + 1)."'>NEXT</a></li>";
                        }
                        echo "</ul>";
                    }
